...
class DoctorUpdatePage extends ConsumerStatefulWidget {
...
class _DoctorPageState extends ConsumerState<DoctorUpdatePage> {
  ...
  updateddata(DoctorModel details) {
    ref.watch(DoctorControllerProvider).updateData(details.copyWith(
        name: nameController.text,
        cons: double.parse(consController.text),
        admin: double.parse(adminController.text),
        dis: double.parse(disController.text),
    ...
    consController.text=widget.details.cons.toString();
    adminController.text=widget.details.admin.toString();
    disController.text=widget.details.dis.toString();
    categoryController.text=widget.details.spcl;
    expController.text=widget.details.exp;
    docImage=widget.details.image;
                          ...
                          Column(
                            children: [
                              Container(
                                ...
                                width: width*0.1,
                                decoration: BoxDecoration(
                                  image: DecorationImage(image: NetworkImage(docImage!),fit: BoxFit.fill),
                                  border: Border.all(
                                      color: ColorPage.primarycolor
                                  ),
